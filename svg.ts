...
export default class create_svg {
    ...
    constructor(
        ...
        public circle1: SVGCircleElement
    ) {
        //
    ...
    draw_circle(): void {
        ...
        this.circle1 = <SVGCircleElement>document.createElementNS(this.NS, "circle");
        ...
        let circle2: SVGCircleElement = <SVGCircleElement>document.createElementNS(this.NS, 'circle');
